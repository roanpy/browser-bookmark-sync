...
Install the published `v0.2.1` wheel without cloning the repository:
...
See [CHANGELOG.md](CHANGELOG.md) for the version history. The latest published release is `v0.2.1`.
